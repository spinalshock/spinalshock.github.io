...
const config: Config = {
  ...
  organizationName: "spinalshock", // Usually your GitHub org/user name.
  projectName: "spinalshock.github.io", // Usually your repo name.
  trailingSlash: true,
  ...
  themeConfig: {
    ...
    footer: {
      ...
      //   },
      // ],
      copyright: `Copyright © ${new Date().getFullYear()} Om Athalye`,
    },
    prism: {
